...
(function () {
  ...
  function showSummary() {
    ...
    emailCard.appendChild(createEl('p', { style: { margin: '0 0 10px', color: '#6b7280', fontSize: '14px' } }, [
      ...
      createEl('a', { href: 'mailto:infor@dotcom.website', style: { color: 'inherit', textDecoration: 'underline' } }, ['info@dotcom.website'])
    ]));
        const mailtoUrl = 'mailto:infor@dotcom.website?subject=DotCom%20Online%20Website%20Assets&body=Hi%20DotCom%20Online%2C%0A%0AI%20just%20submitted%20my%20intake.%20Here%20are%20my%20files%20for%20the%20website%20build.%0A%0AName%3A%20%0ABusiness%20Name%3A%20%0APackage%3A%20%0A%0AThank%20you!';
