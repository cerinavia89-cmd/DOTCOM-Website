...
(function () {
  ...
  function showSummary() {
    ...
    const mailtoSubject = encodeURIComponent('DotCom Online Website Assets');
    const mailtoBody = encodeURIComponent(
      `Hi DotCom Online,

I just submitted my intake. Here are my files for the website build.
...
Thank you!`
    ...
    const mailtoUrl = `mailto:info@dotcom.website?subject=${mailtoSubject}&body=${mailtoBody}`;

    emailCard.appendChild(createEl('a', { class: 'dc-btn dc-btn-secondary', href: mailtoUrl }, ['Email My Files →']));
