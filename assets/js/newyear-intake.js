...
(function () {
  ...
  function showSummary() {
    ...
    form.appendChild(createEl('input', { type: 'hidden', name: '_subject', value: 'New Year Deal — Website Brief Submission' }));
    ...
    const fieldMap = {
      ...
      brand_feel: 'brand_feel',
      color_palette: 'color_palette',
      copy_status: 'copy_status',
      written_text: 'written_text',
      about_text: 'about_info',
      full_name: 'name',
      email: 'email',
